...
filename = "C:/Users/rensk/Documents/Amsterdam/revolve2/stats/morph_045-065/run 1/gen_to_robots.json."
with open(filename, "r") as f:
    gen_to_robot = json.load(f)
    gen_to_robot = gen_to_robot
    
    
filename = "C:/Users/rensk/Documents/Amsterdam/revolve2/stats/morph_045-065/run 1/uuid_to_measures.json."
with open(filename, "r") as f:
