...
# Load JSON file
with open("C:/Users/rensk/Documents/Amsterdam/revolve2/stats/morph_0-045/run 1/stats.json", "r") as f:
    data = json.load(f)
...
for generation in range(100):
    for robot in data["robot_stats"]:
        ...
        if generation > initial_gen and generation <= max_gen:
            ...
            if fitness != 0 and fitness < 14:
                fitness_per_gen[generation].append(fitness)


filename = "C:/Users/rensk/Documents/Amsterdam/revolve2/stats/morph_0-1/fitness_per_gen.json."
experiment_id = 1
