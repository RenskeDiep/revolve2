...
filename = "C:/Users/rensk/Documents/Amsterdam/revolve2/stats/standard_setup_k2/mating_meeting_dict.json."
...
plt.title("Average % Matings/Meetings and Number of Meetings and Matings per Generation, Standard Setup")
plt.show()