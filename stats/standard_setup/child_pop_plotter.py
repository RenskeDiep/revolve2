...
filename = "C:/Users/rensk/Documents/Amsterdam/revolve2/stats/standard_setup/child_pop_dict.json."
...
plt.ylabel("Novelty")
plt.title("Average Novelty of New Offspring in Population per Generation, Standard Setup")
plt.legend()
plt.show()